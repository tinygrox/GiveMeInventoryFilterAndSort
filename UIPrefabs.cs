...
public static class UIPrefabs
{
    ...
    static UIPrefabs()
    {
        GameObject levelManager = GameplayDataSettings.Prefabs.LevelManagerPrefab.gameObject;

        GameObject gameplayUICanvas = levelManager.transform.Find("GameplayUICanvas").gameObject;
